...
const ReferralScreen = ({ navigation }) => {
  ...
  const loadReferralData = async () => {
    try {
      setLoading(true);
      const settings = await settingsApi.getReferralSettings('driver');
      ...
      if (!code && user?.id) {
        ...
        if (!code) {
          code = referralApi.generateReferralCode(user.id, 'driver');
          await referralApi.saveReferralCode(user.id, 'driver', code);
        }
      }
      setReferralCode(code || 'DRIVE123456');
  ...
  const handleShare = async () => {
    try {
      const message = `Become a ${appConfig.name} driver using my referral code ${referralCode} and get ${referralSettings?.refereeReward || '$25'} bonus! ${referralSettings?.description || ''}`;
      
      const result = await Share.share({
        message,
        title: `Join ${appConfig.name} as a Driver`,
      });
  ...
  const handleShareApp = async () => {
    try {
      ...
      const message = `Check out ${appConfig.name}! Download the app and use my referral code ${referralCode} to get ${referralSettings?.refereeReward || '$20 Bonus'}! ${appStoreUrl}`;
        ...
        <Card variant="elevated" style={styles.heroCard}>
          ...
          >
            ...
            <Text style={styles.heroSubtitle}>
              Refer drivers to {appConfig.name} and earn rewards!
            </Text>
          </LinearGradient>
        </Card>
          ...
          <View style={styles.benefitItem}>
            ...
            <View style={styles.benefitContent}>
              ...
              <Text style={styles.benefitValue}>
                {referralSettings?.referrerReward || '$50'}
              </Text>
              <Text style={styles.benefitDescription}>
                When your friend becomes a driver and completes their first 10 rides
              </Text>
            </View>
          </View>
          <View style={styles.benefitItem}>
            ...
            <View style={styles.benefitContent}>
              ...
              <Text style={styles.benefitValue}>
                {referralSettings?.refereeReward || '$25'}
              </Text>
              <Text style={styles.benefitDescription}>
                Bonus when they join as a driver using your code
              </Text>
            </View>
          </View>
        </Card>
        ...
        <Card variant="elevated" style={styles.howItWorksCard}>
          ...
          <View style={styles.stepItem}>
            ...
            <Text style={styles.stepText}>
              Share your referral code with friends who want to become drivers
            </Text>
          </View>
          <View style={styles.stepItem}>
            <View style={styles.stepNumber}>
            ...
            <Text style={styles.stepText}>
              Your friend signs up as a driver using your referral code
            </Text>
          </View>
          <View style={styles.stepItem}>
            <View style={styles.stepNumber}>
            ...
            <Text style={styles.stepText}>
              Your friend completes their first 10 rides and you both get rewarded!
            </Text>
          </View>
        </Card>
      </ScrollView>
